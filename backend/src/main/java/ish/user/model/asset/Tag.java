...
public class Tag {
    ...
    @Schema(accessMode = Schema.AccessMode.READ_ONLY, description = "Tag ID", example = "456")
    private long id;
    ...
    @Schema(description = "Company owning the tag", implementation = Company.class)
    @JsonIgnore
