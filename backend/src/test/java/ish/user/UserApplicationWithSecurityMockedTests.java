...
class UserApplicationWithSecurityMockedTests {
	...
	*/
	...
	void testGetUserById() throws Exception {
		...
		when(repository.findById(Mockito.anyLong())).thenAnswer(
	...
	@Test
	void testGetUserById_shouldBeUnauthorized() throws Exception {
		mockMvc.perform(get("/api/v1.0/users/" + 0))
				.andDo(print())
